...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_newticket_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='newticket'
        )
        self.assertTrue(view.__name__ == 'newticket')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in newticket'
        # )

    def test_newticket_not_matching_interface(self):
